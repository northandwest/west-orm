...
import com.bucuoa.west.orm.core.utils.ShardAnnoationUtil;
import com.bucuoa.west.orm.shard.ShardInfo;
import com.bucuoa.west.orm.shard.holder.DbShardHolder;
import com.bucuoa.west.orm.shard.route.IRouter;
import com.bucuoa.west.orm.shard.route.RouteFactory;
...
public class ShardTableInfo extends BaseTableInfo implements ITableInfo {
	...
	public <T> ShardTableInfo(T t) {
		...
		this.shardInfo = ShardAnnoationUtil.getShardTableInfo(t);
